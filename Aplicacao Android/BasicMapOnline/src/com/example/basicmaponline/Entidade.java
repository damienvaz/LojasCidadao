...
public class Entidade extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			Log.d("ENTIDADE2",entidade.getNome_entidade());
		...
		Log.d("ENTIDADE3",entidade.getNome_entidade());
		...
		Button entidadeButton = (Button) findViewById(R.id.entidadeButton);
		entidadeButton.setOnClickListener(this);
		/*entidadeButton.setOnClickListener(new View.OnClickListener() {
	...
	public class loadDatabase extends AsyncTask<Integer, Void, SQLentidade>{
		...
		protected SQLentidade doInBackground(Integer...id) {	
			...
			try {
				...
				entidade = pSQL.getEntidade(pSQL.getEntidadeQuery(id[0])); /* Meter a query certa*/
